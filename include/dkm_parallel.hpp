...
/*
This type alias represents the type used for measuring and indexing the length of the point data vector
*/
template <typename T, size_t N>
using point_data_size_t = typename std::vector<std::array<T, N>>::size_type;
